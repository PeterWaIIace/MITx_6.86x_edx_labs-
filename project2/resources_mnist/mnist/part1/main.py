...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print("mod3 error: ",compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter))
...
# temp_parameter=1
# print(f"run_softmax_on_MNIST_mod3(temp_parameter={temp_parameter}): ",run_softmax_on_MNIST_mod3(temp_parameter=temp_parameter))
...
print('softmax pca test_error=', run_softmax_on_MNIST_pca(temp_parameter=1,n_components=18))
...
def run_softmax_on_MNIST_cubic_feautres(temp_parameter=1,n_components=10):
    """
    Trains Softmax regression on digit (cubic features) classifications.
...
print('softmax cubic features test_error=', run_softmax_on_MNIST_cubic_feautres(temp_parameter=1,n_components=10))
